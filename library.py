...
administrator.add_book("Harry potter", "Ahmed Ali", "978-0743273565", 3)
administrator.add_book("Jannat ke pattee", "Fiza Sheikh", "978-0061120084", 2)

administrator.add_patron("Fiza", 1)
administrator.add_patron("Ahmed", 2)
...
administrator.remove_book("The Great Gatsby")
